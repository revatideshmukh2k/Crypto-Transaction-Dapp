...
class App extends Component {
  ...
  render() {
    return (
      <div className="text-monospace mainbody" >
        ...
        <div  className="container-fluid mt-5 text-center">
          <br></br>
          <h1>Welcome to World Decentralize Bank</h1>
                ...
                <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example">
                  <Tab eventKey="deposit" title="Deposit">
                    <div>
                      ...
                      <br></br>
                      <h5>(1 deposit is possible at the time)</h5>
                      <br></br>
                      <form
                        onSubmit={(e) => {
                          e.preventDefault();
                      ...
                      >
                        ...
                        <button type="submit" className="btn btn-outline-primary dp-btn">
                          DEPOSIT
                        </button>
                      </form>
                    </div>
                  ...
                  <Tab eventKey="withdraw" title="Withdraw">
                    ...
                    <div>
                      <button
                        type="submit"
                        className="btn btn-outline-primary dp-btn"
                  ...
                  <Tab eventKey="borrow" title="Borrow">
                    <div>
                      <br></br>
                      <h4>Do you want to borrow tokens?</h4>
                      <br></br>
                      <br></br>
                      <form
                        onSubmit={(e) => {
                  ...
                  <Tab eventKey="payOff" title="Payoff">
                    <div>
                      <br></br>
                      <h4>Do you want to payoff the loan?</h4>
                      <br></br>
                      <br></br>
                      <button
                        type="submit"
